...
export const visaCountries: VisaCountry[] = [
  ...
  { slug: 'my', country: 'Hoa Kỳ', flag: '🇺🇸', region: 'Bắc Mỹ', visaTypes: ['B1/B2'], processingTime: 'Theo lịch phỏng vấn', stayDuration: 'Theo dấu nhập cảnh', popular: true, summary: 'Visa B1/B2 yêu cầu phỏng vấn tại Lãnh sự quán. Canaan hỗ trợ hồ sơ và luyện phỏng vấn.' },
  ...
  { slug: 'ai-cap', country: 'Ai Cập', flag: '🇪🇬', region: 'Châu Phi', visaTypes: ['e-Visa', 'Visa on arrival'], processingTime: '3–5 ngày làm việc', stayDuration: '30 ngày', popular: false, summary: 'Visa Ai Cập cấp điện tử hoặc tại cửa khẩu tuỳ diện; Canaan tư vấn theo hành trình.' },
  ...
  { slug: 'israel', country: 'Israel', flag: '🇮🇱', region: 'Trung Đông', visaTypes: ['Miễn/e-Visa tuỳ diện'], processingTime: 'Theo quy định hiện hành', stayDuration: '90 ngày', popular: false, summary: 'Chính sách nhập cảnh Israel thay đổi theo thời điểm; Canaan cập nhật khi tư vấn đoàn.' },
...
export const VISA_DISCLAIMER =
  'Canaan Tourism cung cấp dịch vụ tư vấn và hỗ trợ hồ sơ. Quyết định cấp hoặc từ chối visa thuộc về cơ quan lãnh sự hoặc cơ quan di trú có thẩm quyền. Canaan Tourism không cam kết đậu visa.';
