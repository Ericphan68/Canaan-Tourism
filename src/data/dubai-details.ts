...
export function getDubaiDetail(exp: DubaiExperience): DubaiDetail {
  return {
    ...
    faqs: [
      { question: 'Tôi đặt xong có xác nhận ngay không?', answer: 'Với sản phẩm giá cố định, bạn nhận xác nhận nhanh. Một số dịch vụ cần Canaan kiểm tra chỗ và báo lại.' },
