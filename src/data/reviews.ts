...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    quote:
      'Đoàn 32 người đi Đất Thánh được sắp xếp chu đáo, có giờ tĩnh nguyện mỗi ngày. Canaan hiểu rõ nhu cầu của đoàn hành hương.',
  ...
  },
  {
    ...
    rating: 5,
    quote:
      'Gala kỷ niệm 15 năm tại Dubai cho 120 khách được Canaan Events lo trọn gói. Sân khấu, AV và hậu cần đều chuyên nghiệp.',
