...
const ctaByTopic: Record<string, RelatedCta> = {
  ...
  Events: { label: 'Tổ chức sự kiện cùng Canaan', href: '/events', description: 'Nhận tư vấn tổ chức sự kiện trong nước và quốc tế.' },
  ...
  'Luxury Travel': { label: 'Khám phá Canaan Signature', href: '/signature', description: 'Hành trình luxury thiết kế riêng cho bạn.' },
...
export function getArticleCta(article: Article): RelatedCta {
  return (
    ctaByTopic[article.topic] ?? {
      label: 'Nhận tư vấn từ Canaan',
      href: '/yeu-cau-bao-gia',
      description: 'Gửi nhu cầu, đội ngũ Canaan sẽ liên hệ và báo giá.',
    }
  );
}
  ...
  return [
    {
      heading: 'Tổng quan',
      paragraphs: [
        `${article.excerpt} Bài viết này tổng hợp kinh nghiệm thực tế từ đội ngũ Canaan Tourism, giúp bạn chuẩn bị chu đáo hơn cho hành trình liên quan đến ${d}.`,
