...
const authored: Record<string, Partial<VisaDetail>> = {
  ...
  my: {
    ...
    process: [
      ...
      'Chuẩn bị hồ sơ & luyện phỏng vấn cùng Canaan',
      'Tham dự phỏng vấn',
...
export function getVisaDetail(visa: VisaCountry): VisaDetail {
  ...
  return {
    ...
    faqs: a.faqs ?? [
      ...
      { question: 'Canaan có cam kết đậu visa không?', answer: 'Không. Canaan tư vấn và hỗ trợ hồ sơ để tối ưu khả năng thành công; quyết định cấp visa thuộc về cơ quan có thẩm quyền.' },
      { question: 'Tôi từng bị từ chối visa thì sao?', answer: 'Bạn vẫn có thể nộp lại. Canaan sẽ rà soát nguyên nhân và tư vấn cách củng cố hồ sơ.' },
    ],
  };
}
