    ...
    return (
      <div className="flex flex-col items-center rounded-2xl bg-ivory-100 p-10 text-center shadow-card">
        ...
        <p className="mt-2 max-w-md text-sm text-ink-muted">
          Chuyên viên Canaan Events sẽ liên hệ để trao đổi concept và gửi đề xuất kèm báo giá.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <fieldset className="mt-5">
        <legend className="mb-2 text-xs font-semibold text-ink-muted">Bạn cần Canaan lo những gì?</legend>
