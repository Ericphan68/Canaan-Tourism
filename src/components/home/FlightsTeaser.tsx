  ...
  return (
    <Section background="ivory">
      <SectionHeader
        ...
        description="Canaan tổng hợp giá tham khảo từ các đối tác. Bạn chọn được vé ưng ý, hoặc để đội ngũ săn giá giúp."
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-[1fr_1.3fr]">
        ...
        <div className="relative flex flex-col justify-end overflow-hidden rounded-2xl p-7 text-white shadow-card">
          ...
          <div className="relative max-w-md">
            <span className="eyebrow text-champagne-400">Canaan Signature</span>
            <h3 className="mt-2 font-display text-2xl font-medium">
              Vé thương gia &amp; hạng nhất giá tốt
            </h3>
            <p className="mt-2 text-sm text-white/75">
              Gửi hành trình và ngân sách, chuyên viên Canaan săn giá khoang thương gia từ nhiều hãng
