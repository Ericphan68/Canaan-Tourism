  ...
  return (
    <Link href="/" className={cn('group inline-flex items-center gap-2.5', className)} aria-label="Canaan Tourism — trang chủ">
      <svg width="34" height="34" viewBox="0 0 34 34" fill="none" aria-hidden className="shrink-0">
        <circle cx="17" cy="17" r="16" stroke="#C6A15B" strokeWidth="1.2" opacity="0.5" />
        <path
        ...
        />
        <path d="M7 22 17 8l10 14" stroke="#C6A15B" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0" />
        <circle cx="7" cy="22" r="2" fill="#C6A15B" />
        <circle cx="27" cy="22" r="2" fill="#C6A15B" />
        <path d="M17 6l1.4 3 3 .3-2.3 2 .7 3-2.8-1.6L14 15l.7-3-2.3-2 3-.3L17 6Z" fill="#C6A15B" />
      </svg>
