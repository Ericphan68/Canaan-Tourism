...
const services = [
  ...
  { value: 'signature', label: 'Canaan Signature (luxury)' },
    ...
    return (
      <div className="flex flex-col items-center rounded-2xl border border-mist bg-ivory-100 p-10 text-center">
        ...
        <p className="mt-2 max-w-md text-sm text-ink-muted">
          Cảm ơn bạn! Chuyên viên Canaan sẽ liên hệ trong thời gian sớm nhất để tư vấn và báo giá.
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        ...
        <span className="text-xs text-ink-soft">Canaan phản hồi trong giờ làm việc. Thông tin của bạn được bảo mật.</span>
      </div>
    </form>
  );
}
