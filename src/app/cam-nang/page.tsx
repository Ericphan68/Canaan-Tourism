...
export const metadata: Metadata = {
  title: 'Cẩm nang du lịch Canaan',
  description:
    'Kinh nghiệm visa, vé máy bay, khách sạn, tour, sự kiện và hành hương — viết bởi đội ngũ Canaan Tourism, mỗi bài kèm hành động liên quan.',
};
      ...
      <section className="shell py-12">
        ...
        {results.length > 0 ? (
          ...
          <EmptyState
            ...
            description="Chúng tôi liên tục cập nhật cẩm nang. Trong lúc chờ, bạn có thể nhắn đội ngũ Canaan để được tư vấn trực tiếp."
