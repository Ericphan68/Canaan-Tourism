...
export const metadata: Metadata = {
  ...
  description:
    'Tra cứu và so sánh giá vé máy bay tham khảo từ các nền tảng đối tác, hoặc để chuyên viên Canaan săn giá giúp. Có dịch vụ vé thương gia & hạng nhất.',
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Canaan tổng hợp giá tham khảo từ nhiều nền tảng đối tác. Bạn chọn được vé ưng ý, hoặc để đội ngũ săn giá giúp."
      ...
      <section className="bg-mist-200/50 py-14">
        <div className="shell grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-3 text-display-md font-medium text-midnight">Nhờ nhân viên Canaan kiểm giá</h2>
      ...
      <section id="business" className="scroll-mt-24 bg-midnight py-14 lg:py-20">
        <div className="shell grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          <div className="text-white">
            <span className="eyebrow text-champagne-400"><IconSparkle className="h-4 w-4" /> Canaan Signature</span>
