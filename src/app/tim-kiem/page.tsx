...
export const metadata: Metadata = {
  title: 'Tìm kiếm',
  description: 'Tìm tour, điểm đến, visa, khách sạn và cẩm nang trên Canaan Tourism.',
};
        ...
        <div className="mx-auto mt-10 max-w-3xl">
          ...
          {results.length > 0 ? (
            ...
            <EmptyState
              ...
              description="Thử từ khoá khác, hoặc để đội ngũ Canaan tư vấn trực tiếp cho bạn."
