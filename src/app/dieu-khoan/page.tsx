...
export const metadata: Metadata = {
  ...
  description: 'Điều khoản sử dụng và chính sách bảo mật của Canaan Tourism.',
};

const terms = [
  { h: 'Giới thiệu', p: 'Bằng việc truy cập và sử dụng website Canaan Tourism, bạn đồng ý với các điều khoản dưới đây. Vui lòng đọc kỹ trước khi sử dụng dịch vụ.' },
  ...
  { h: 'Dịch vụ đối tác', p: 'Với các liên kết chuyển sang nền tảng đối tác (vé máy bay, khách sạn), việc đặt và thanh toán diễn ra trên nền tảng đó theo điều khoản của họ. Canaan Tourism không chịu trách nhiệm cho nội dung của bên thứ ba.' },
  { h: 'Trách nhiệm về visa', p: 'Canaan Tourism cung cấp dịch vụ tư vấn và hỗ trợ hồ sơ. Quyết định cấp hoặc từ chối visa thuộc về cơ quan lãnh sự hoặc cơ quan di trú có thẩm quyền. Canaan Tourism không cam kết đậu visa.' },
  ...
  return (
    <>
      <PageHero
        eyebrow="Pháp lý"
        title="Điều khoản & Bảo mật"
        description="Các điều khoản sử dụng và chính sách bảo mật khi bạn sử dụng dịch vụ của Canaan Tourism."
