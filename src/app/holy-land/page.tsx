...
export const metadata: Metadata = {
  title: 'Canaan Holy Land Journeys — Hành trình về Đất Thánh',
  description:
...
export default async function HolyLandPage({
  ...
  return (
    <>
      <PageHero
        eyebrow="Canaan Holy Land Journeys"
      ...
      <section className="shell pb-16">
        ...
        {results.length > 0 ? (
          ...
          <EmptyState
            ...
            description="Canaan có thể thiết kế đoàn riêng theo chủ đề và lịch của hội thánh bạn."
        ...
        <div className="shell flex flex-col items-start justify-between gap-6 py-12 sm:flex-row sm:items-center">
          <div className="max-w-xl text-white">
            ...
            <p className="mt-2 text-white/70">
              Canaan đồng hành cùng mục sư và lãnh đạo: thiết kế lộ trình theo chủ đề, lo trọn hậu cần và
