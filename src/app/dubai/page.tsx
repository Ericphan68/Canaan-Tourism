...
export const metadata: Metadata = {
  ...
  description:
    'Desert Safari, Burj Khalifa, du thuyền Marina, Abu Dhabi, trực thăng và nhiều trải nghiệm Dubai. Đặt trực tuyến hoặc nhờ Canaan hỗ trợ.',
};
      ...
      <section className="shell py-12">
        ...
        {results.length > 0 ? (
          ...
          <EmptyState
            ...
            description="Nhắn nhân viên Canaan để sắp xếp trải nghiệm Dubai theo yêu cầu của bạn."
            action={<Button href="/yeu-cau-bao-gia?type=dubai" variant="primary">Nhờ Canaan hỗ trợ</Button>}
          />
        )}
      </section>
