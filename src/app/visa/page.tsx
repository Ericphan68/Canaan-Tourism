...
export const metadata: Metadata = {
  ...
  description:
    'Kiểm tra điều kiện visa theo quốc gia đến, quốc tịch và nơi cư trú. Canaan tư vấn và hỗ trợ hồ sơ cho nhiều quốc gia.',
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Chọn nơi bạn muốn đến, Canaan tư vấn điều kiện hồ sơ theo quốc tịch và nơi cư trú. Chúng tôi hỗ trợ hồ sơ — không cam kết đậu visa."
        ...
        <div className="shell flex flex-col items-start justify-between gap-6 py-12 sm:flex-row sm:items-center">
          <div className="max-w-xl text-white">
            ...
            <p className="mt-2 text-white/70">
              Gửi thông tin, chuyên viên visa của Canaan sẽ đánh giá hồ sơ và tư vấn lộ trình phù hợp cho bạn.
            </p>
          </div>
