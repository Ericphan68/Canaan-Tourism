...
export const metadata: Metadata = {
  title: 'Liên hệ Canaan Tourism',
  description: 'Liên hệ đội ngũ Canaan Tourism qua WhatsApp, điện thoại, email hoặc form. Văn phòng tại TP.HCM và Dubai.',
};
...
export default function ContactPage() {
  return (
    <>
      <PageHero
        eyebrow="Liên hệ"
        title="Nói chuyện với đội ngũ Canaan"
