...
export const metadata: Metadata = {
  title: 'Đăng nhập (mẫu)',
  description: 'Trang đăng nhập mẫu của Canaan Tourism — minh hoạ giao diện tài khoản khách hàng.',
  robots: { index: false },
};
    ...
    <section className="grid min-h-[calc(100vh-4rem)] lg:grid-cols-2">
      ...
      <div className="relative hidden lg:block">
        ...
        <div className="absolute bottom-10 left-10 right-10 text-white">
          ...
          <p className="mt-2 max-w-md text-white/75">
            Đăng nhập để theo dõi đơn đặt, yêu cầu báo giá và hành trình đã lưu cùng Canaan.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center bg-ivory px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="mt-1 text-sm text-ink-muted">Chào mừng trở lại với Canaan Tourism.</p>
          <div className="mt-6">
            <LoginForm />
          </div>
        </div>
