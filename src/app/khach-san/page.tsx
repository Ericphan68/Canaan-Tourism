          ...
          <div>
            ...
            {results.length > 0 ? (
              ...
              <EmptyState
                ...
                description="Thử nới lỏng điều kiện, hoặc để Canaan tìm giúp nơi lưu trú phù hợp — kể cả cho đoàn."
                action={<Button href="/yeu-cau-bao-gia?type=hotel" variant="primary">Nhờ Canaan tìm phòng</Button>}
              />
            )}
          </div>
        </div>
        ...
        <div className="shell flex flex-col items-start justify-between gap-6 py-12 sm:flex-row sm:items-center">
          <div className="max-w-xl text-white">
            ...
            <p className="mt-2 text-white/70">
              Đặt số lượng phòng lớn, phòng họp, tiệc và ưu đãi đoàn. Canaan thương lượng giá và giữ chỗ giúp bạn.
            </p>
          </div>
