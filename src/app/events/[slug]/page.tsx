...
export async function generateMetadata({
  ...
  if (type) return { title: `${type.title} — Canaan Events`, description: type.summary };
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-midnight text-white">
        ...
        <div className="shell py-10 sm:py-14">
          ...
          <span className="eyebrow mt-5 text-champagne-400"><span className="route-dot" /> Canaan Events</span>
      ...
      <div className="shell space-y-14 py-12 lg:py-16">
        {country ? (
          ...
          <>
            <Block title="Canaan hỗ trợ những gì">
              <ul className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-3">
                {eventServices.map((s) => (
                  <li key={s} className="flex items-center gap-2 text-sm text-ink-muted">
                    <IconCheck className="h-4 w-4 shrink-0 text-emerald-600" /> {s}
      ...
      <section className="bg-mist-200/50 py-14">
        <div className="shell">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-ink-muted">Chia sẻ nhu cầu, Canaan Events sẽ gửi đề xuất và báo giá chi tiết.</p>
          </div>
          <div className="mt-8">
