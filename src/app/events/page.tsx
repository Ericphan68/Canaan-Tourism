...
export const metadata: Metadata = {
  title: 'Canaan Events — Tổ chức sự kiện quốc tế',
  description:
    ...
    <>
      ...
      <section className="shell py-14">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-display-md font-medium text-midnight">Canaan tổ chức những gì</h2>
        </div>
          ...
          {eventTypes.map((ev) => (
            ...
            >
              <Image
                ...
                className="object-cover transition-transform duration-700 ease-canaan group-hover:scale-105"
              />
      ...
      <section className="shell py-14">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          {eventCountries.map((c) => (
            ...
            >
              <Image src={c.image} alt={c.name} fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-cover transition-transform duration-700 ease-canaan group-hover:scale-105" />
      ...
      <section className="shell py-14">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-ink-muted">Điền thông tin, đội ngũ Canaan Events sẽ liên hệ với đề xuất phù hợp.</p>
        </div>
        <div className="mt-8">
          <EventForm />
        </div>
