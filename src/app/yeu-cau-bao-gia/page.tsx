...
export const metadata: Metadata = {
  ...
  description:
    'Gửi yêu cầu để nhận tư vấn và báo giá cho tour, vé máy bay, khách sạn, visa, sự kiện hoặc hành trình luxury từ đội ngũ Canaan Tourism.',
};
  ...
  return (
    <>
      <PageHero
        ...
        title="Nhận tư vấn & báo giá từ Canaan"
        description="Chia sẻ nhu cầu của bạn — tour, vé, khách sạn, visa, sự kiện hay hành trình luxury. Đội ngũ Canaan sẽ liên hệ với đề xuất phù hợp."
      ...
      <section className="shell grid gap-10 py-12 lg:grid-cols-[1fr_20rem] lg:py-16">
        ...
        <aside className="space-y-4">
          <div className="rounded-2xl bg-midnight p-6 text-white">
            ...
            <p className="mt-1 text-sm text-white/70">Liên hệ trực tiếp với đội ngũ Canaan.</p>
