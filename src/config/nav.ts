...
export const mainNav: NavItem[] = [
    ...
    megaMenu: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: 'Tour hành hương', href: '/holy-land', description: 'Canaan Holy Land Journeys' },
  ...
  },
  {
    ...
    feature: {
      ...
      description: 'Gửi hành trình, đội Canaan săn giá khoang thương gia & hạng nhất cho bạn.',
  ...
  { label: 'Về Canaan', href: '/ve-canaan' },
...
export const footerNav: NavGroup[] = [
  {
    ...
    children: [
      ...
      { label: 'Canaan Holy Land', href: '/holy-land' },
      { label: 'Dubai Experiences', href: '/dubai' },
      { label: 'Canaan Signature', href: '/signature' },
    ],
  },
  {
    heading: 'Dịch vụ',
    children: [
      ...
      { label: 'Khách sạn', href: '/khach-san' },
      { label: 'Visa', href: '/visa' },
      { label: 'Canaan Events', href: '/events' },
  ...
  },
  {
    heading: 'Canaan',
    children: [
      { label: 'Về chúng tôi', href: '/ve-canaan' },
